"""
PEAQ (ITU-R BS.1387) tylko dla nowych wariantów:
  - aur8
  - aur4

Używa aquatk.metrics.PEAQ.peaq_basic.process_audio_files()
Wyniki zapisuje do osobnego CSV.
"""
...
OUTPUT_CSV = r"C:\Users\Lenovo\Desktop\Magisterka\wyniki_PEAQ_8k_4k.csv"
...
print("=" * 75)
print("PEAQ (ITU-R BS.1387) — TYLKO 8 kHz i 4 kHz")
print("=" * 75)
print()
...
for task in TASKS:
    ...
    for var in VARIANTS:
        ...
        if not os.path.exists(deg_path):
            print(f"  {var['key']:>8}: BRAK PLIKU -> {deg_path}")
            continue
